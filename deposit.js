    ...
    <Card
      ...
      body={show ? (  
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-dark" style={{color: "yellow"}} disabled={disabled}>Deposit</button>
              </form>
            ):(
              <form onSubmit={clearForm}>
                ...
                <button type="submit" className="btn btn-dark" style={{color: "yellow"}} disabled={disabled}>Make another deposit</button>
              </form>
            )}
    />
  )
